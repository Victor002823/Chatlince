...
export const AuthButton = ({
  ...
  const getButtonStyles = () => {
    ...
    const variantStyles = variant === 'filled' ? 'bg-blue-800 dark:bg-blueDark-800' : 'bg-gray-50 dark:bg-grayDark-50';
  ...
  const getTextStyles = () => {
    ...
    const colorStyles = variant === 'filled' ? 'text-white dark:text-grayDark-50' : 'text-gray-950 dark:text-grayDark-950';
