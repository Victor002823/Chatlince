...
export const InboxHeader = (props: InboxHeaderProps) => {
  ...
  return (
    <Animated.View style={[tailwind.style('border-b-[1px] border-b-blackA-A3 dark:border-b-whiteA-A3 bg-blue-800 dark:bg-blueDark-800')]}>
      <Animated.View
        ...
        <Animated.View style={tailwind.style('flex-1')}>
          <Animated.Text
            style={tailwind.style(
              'text-[17px] text-center leading-[17px] tracking-[0.32px] font-inter-medium-24 text-white',
            )}>
