...
const variantBaseMap = {
  ...
  [MESSAGE_VARIANTS.USER]: 'bg-blackA-A7 dark:bg-whiteA-A7',
};
        ...
        <Animated.View style={tailwind.style('pl-2.5')}>
          <Animated.Text
            style={tailwind.style(
              'text-cxs font-inter-420-20 leading-[14.95px] tracking-[0.32px] text-blackA-A11 dark:text-whiteA-A11',
            )}>
          ...
          {hasAttachments ? (
            <Animated.View style={tailwind.style('py-[3px] flex flex-row items-center')}>
              ...
              <Animated.Text
                style={tailwind.style(
                  'text-[14px] font-inter-normal-20 leading-[19.6px] tracking-[0.16px] text-gray-950 dark:text-grayDark-950 pl-1.5',
                )}>
