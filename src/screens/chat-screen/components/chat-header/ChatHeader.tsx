...
export const ChatHeader = ({
  ...
  return (
    <Animated.View style={[tailwind.style('border-b-[1px] border-b-blackA-A3 bg-blue-800 dark:bg-blueDark-800')]}>
      <Animated.View style={tailwind.style('flex flex-row justify-between items-center px-4 py-2')}>
        <Animated.View style={tailwind.style('flex-1 flex-row gap-2 items-center justify-center')}>
          <Pressable
            ...
            onPress={onBackPress}>
            <Icon icon={<ChevronLeft stroke="white" />} size={24} />
          </Pressable>
          <Pressable
            ...
            <Animated.View style={tailwind.style('pl-2')}>
              <Animated.Text
                ...
                style={tailwind.style(
                  'text-[17px] font-inter-medium-24 tracking-[0.32px] text-white',
                )}>
                {name}
              </Animated.Text>
            </Animated.View>
        ...
        <Animated.View
          ...
          {dashboardsList.length > 0 && (
            <ChatDropdownMenu dropdownMenuList={dashboardsList}>
              <Icon icon={<Overflow strokeWidth={2} stroke="white" />} size={24} />
            </ChatDropdownMenu>
          )}
        </Animated.View>
      </Animated.View>
