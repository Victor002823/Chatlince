  ...
  <View style={tailwind.style('flex-row items-center mb-4')}>
    <Animated.Text
      style={tailwind.style(
        'w-8 text-[15px] font-inter-medium-24 tracking-[0.225px] text-gray-500 dark:text-grayDark-500',
      )}>
      {label}
    </Animated.Text>
    <BottomSheetTextInput
      ...
      style={tailwind.style(
        'flex-1 px-3 py-2 rounded-[10px] border text-base font-inter-420-20 text-gray-950 dark:text-grayDark-950',
